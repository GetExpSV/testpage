    ...
    return (<div>
        <div className={info_class.mainItem}>
            ...
            <div className={info_class.infoItem}>
                <img src={manLaptop}/>
                <div className={info_class.textItem}>
                    <div className={info_class.textHead}>I am cool frontend developer</div>
                    <div> We will evaluate how clean your approach to writin CSS and
                        Javascript code is. You can use any CSS
                        and Javascript 3rd
                        party libraries without any restriction.
                    </div>
                    <div>If 3rd party css/javascript libraries are added to the project
